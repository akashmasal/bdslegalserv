...
.error{
    ...
    <body  onload="autoPop();">
        <div class="container">
            ...
            <div class="row marketing"> <!-- action="https://bdsserv.com/VPC/merchant_do.php" -->
                    ...
                    <div class="col-lg-6"> 
                       ...
                       <input type="hidden" name="mode" value="1" />
                            ...
                            <div class="col-sm-11" style="display:flex;">
                                <input type="text" class="form-control" id="firstname" name="buyerFirstName" placeholder="Your First Name" 
                                      style="width:50%;display:inline-flex;" required>
                                      &nbsp;
                                       <input type="text" class="form-control" id="lastname" name="buyerLastName" placeholder="Your Last Name" 
                                        style="width:50%;display:inline-flex;" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <input type="text" class="form-control" id="nationality" name="buyerCountry" placeholder="Your Nationality" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <input type="text" class="form-control" id="contactno" name="buyerPhoneNumber" placeholder="Contact Number"
                                       value="<?= isset($_POST['contactno']) ? $_POST['contactno'] : "" ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="emailaddress" class="col-sm-9">Your Email Address:</label>
                            <div class="col-sm-11">
                                <input type="email" class="form-control" id="emailaddress" name="buyerEmail" placeholder="Email Address"
                                       value="<?= isset($_POST['emailaddress']) ? $_POST['emailaddress'] : "" ?>" required>
                            </div>
                        </div>
                    ...
                    -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                ...
                                <input type="text" class="form-control" id="orderId" name="orderId" placeholder="Order Information"
                                        required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="merchantIpAddress" value="127.0.0.1" /> 
                            <div class="col-sm-11">
                                <input value="BDS-<?= date('dmy') ?>-<?= rand(786786, 786786786) ?>" type="text" 
                                       class="form-control" id="vpc_MerchTxnRef" name="vpc_MerchTxnRef" 
                                       placeholder="Transaction Reference Code" readonly >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="vpc_DCCAmount" class="col-sm-9">Amount:</label>
                            <div class="col-sm-11">
                                <input type="number" class="form-control" id="vpc_DCCAmount" name="amount" 
                                       placeholder="Amount"
                                       value="<?= isset($_POST['vpc_DCCAmount']) ? $_POST['vpc_DCCAmount'] : "" ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
