...
class Checksum
{
	...
	static function getAllParams()
	{
		...
		$url = "http://free.currencyconverterapi.com/api/v6/convert?q=" . $currency . "_INR&compact=ultra&apiKey=f6b7bf1f81d00eaa624a";
		$ch = curl_init();
		$timeout = 0;
		...
		$con = new PDO('mysql:host=localhost;dbname=bdsserv_BDS_Mobikwik', 'bdsserv_vikrantd', 'Mumbai@#123');
		if (!$con) {
